...
furniture.ClearenceController = class ClearenceController extends erpnext.selling.SellingController {
	setup(doc) {
...
extend_cscript(cur_frm.cscript, new furniture.ClearenceController({frm: cur_frm}));
